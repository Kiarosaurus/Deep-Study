...
export const TRANSLATIONS = {
  en: {
    ...
    'viewer.searchHint': 'Click start, then end (same paragraph) · Enter to extract, Del to cancel',
  ...
  es: {
    ...
    'viewer.searchHint': 'Clic inicio, luego fin (mismo párrafo) · Enter para extraer, Supr para cancelar',
  ...
  'zh-Hant': {
    ...
    'viewer.searchHint': '點選起點，再點終點（同一段落）· Enter 擷取，Del 取消',
