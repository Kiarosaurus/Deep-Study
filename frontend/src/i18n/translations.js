...
export const TRANSLATIONS = {
  en: {
    ...
    'home.select': 'Select',
    'home.cancelSelect': 'Cancel',
    'home.selectAll': 'Select all',
    'home.deselectAll': 'Clear',
    'home.selectedCount': ({ n }) => `${n} selected`,
    'home.deleteSelected': ({ n }) => `Delete (${n})`,
    'home.confirmDelete': ({ n }) => `Confirm delete (${n})`,
    ...
    'viewer.toolSplit': 'Scissors — cut a merge (manual or natural)',
    'viewer.toolSearch': 'Magnifier — select text to force-extract a concept',
    'viewer.searchHint': 'Drag to select, drag the knobs to adjust (same paragraph) · Enter to extract, Del to cancel',
    'viewer.searchExtracting': 'Extracting concept…',
    ...
    'viewer.typeAlgorithm': 'Algorithm',
    'viewer.typeIgnored': 'Ignored',
    'viewer.typeTitle': 'Title',
    'viewer.typeAuthor': 'Author',
    'viewer.typeSectionHeader': 'Section header',
    'viewer.typeGroupExplainable': 'Explainable',
    'viewer.typeGroupMetadata': 'Metadata',
  ...
  es: {
    ...
    'home.cancelSelect': 'Cancelar',
    'home.selectAll': 'Seleccionar todo',
    'home.deselectAll': 'Quitar selección',
    'home.selectedCount': ({ n }) => `${n} seleccionados`,
    'home.deleteSelected': ({ n }) => `Eliminar (${n})`,
    'home.confirmDelete': ({ n }) => `Confirmar (${n})`,
    ...
    'viewer.toolSplit': 'Tijeras — cortar una fusión (manual o natural)',
    'viewer.toolSearch': 'Lupa — selecciona texto para forzar la extracción de un concepto',
    'viewer.searchHint': 'Arrastra para seleccionar, arrastra los puntos para ajustar (mismo párrafo) · Enter para extraer, Supr para cancelar',
    'viewer.searchExtracting': 'Extrayendo concepto…',
    ...
    'viewer.typeAlgorithm': 'Algoritmo',
    'viewer.typeIgnored': 'Ignorado',
    'viewer.typeTitle': 'Título',
    'viewer.typeAuthor': 'Autor',
    'viewer.typeSectionHeader': 'Encabezado',
    'viewer.typeGroupExplainable': 'Explicables',
    'viewer.typeGroupMetadata': 'Metadatos',
  ...
  'zh-Hant': {
    ...
    'home.select': '選擇',
    'home.cancelSelect': '取消',
    'home.selectAll': '全選',
    'home.deselectAll': '清除',
    'home.selectedCount': ({ n }) => `已選 ${n} 個`,
    'home.deleteSelected': ({ n }) => `刪除（${n}）`,
    'home.confirmDelete': ({ n }) => `確認刪除（${n}）`,
    ...
    'viewer.toolSplit': '剪刀 — 切斷合併（手動或自動）',
    'viewer.toolSearch': '放大鏡 — 選取文字以強制擷取概念',
    'viewer.searchHint': '拖曳以選取，拖曳圓點以調整（同一段落）· Enter 擷取，Del 取消',
    'viewer.searchExtracting': '正在擷取概念…',
    ...
    'viewer.typeAlgorithm': '演算法',
    'viewer.typeIgnored': '已忽略',
    'viewer.typeTitle': '標題',
    'viewer.typeAuthor': '作者',
    'viewer.typeSectionHeader': '章節標題',
    'viewer.typeGroupExplainable': '可解說',
    'viewer.typeGroupMetadata': '中繼資料',
